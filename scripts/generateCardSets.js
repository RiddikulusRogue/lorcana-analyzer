...
function writeOutput(source, cardSetMapping) {
    ...
    const output = {
        description: 'Maps card names to their set numbers (as arrays to handle reprints). Generated from local allCards data when available, with API fallback. For Core Constructed, a card is legal if ANY of its sets is in 5-11.',
